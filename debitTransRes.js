...
module.exports = function(connection, DataType){
	...
	let debit_tran_res = connection.define('debit_tran_res', {
        ...
        settalement_date: Sequelize.DATE,
	...
	{
        indexes: [ {fields: ['mandate_type'] } ],
        charset: 'utf8',collate: 'utf8_unicode_ci',
        freezeTableName: true,
        tableName: 'debit_tran_res'

});

    return debit_tran_res;
};