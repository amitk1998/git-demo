...
module.exports =  (connection, DataType)=> {
    ...
    let debit_tran_reg = connection.define('debit_tran_reg', {
        ...
        instrument_purpose: Sequelize.STRING,
        mandate_nature: Sequelize.STRING,
        business_segment: Sequelize.STRING,
        bank_branch_id: Sequelize.STRING,
        bank_branch_code:Sequelize.STRING,
        city_code:Sequelize.STRING,
        Bank_Branch_Identifier_Code:Sequelize.STRING,
        bank_code_id:Sequelize.STRING,
        payer_va:Sequelize.STRING,
        upi_notification:Sequelize.STRING,
        upi_notification_retry:Sequelize.STRING,
        ...
        upi_merchant_trans_notification_datetime:Sequelize.STRING,
        upi_merchant_trans_notifiaction_response:Sequelize.JSON,
        upi_merchant_trans_execution_id:Sequelize.STRING,
        upi_merchant_trans_execution_retry_count:Sequelize.STRING,
        upi_merchant_trans_execution_response:Sequelize.JSON,
        ...
        excl_file_uploaded_by:Sequelize.STRING,
        excl_file_flag:Sequelize.BOOLEAN,
        emi_seq_no:Sequelize.INTEGER,
        upi_process_flag:Sequelize.BOOLEAN,
        upi_exe_callback_flag:Sequelize.BOOLEAN,
        upi_exe_callback_status : Sequelize.STRING
    },
        {
